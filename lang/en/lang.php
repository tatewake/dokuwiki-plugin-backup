...
$lang['filterdirs'] = 'List of blacklisted directories, separated by newlines.
These directories will not be included in your backups.
If the following checkbox is selected, then the backup namespace will be implicitly included in this list.';
$lang['filterbackups'] = 'Add backup namespace to blacklisted directory list?
It is <em>highly</em> recommended to keep this option checked, so your new backups don\'t include old backup files.';